...
#from model import generate_model #not used
...
#from medcam import medcam #don't want explainability stuff
...
#model = medcam.inject(model, output_dir=os.path.join(output_dir, "attention_maps"), save_maps=True, backend='ggcam') #don't need
